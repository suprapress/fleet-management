...
export default function P2HChecklist() {
    ...
    // --- STATE ---
    // Memory to store state of each item: { [itemId]: { status: 'ok'|'issue', reason: '', imageUri: null } }
    ...
    const handleStatusChange = (itemId: string, status: ItemStatus) => {
        setInspectionData(prev => ({
            ...
            [itemId]: {
                ...
                imageUri: status === 'ok' ? null : (prev[itemId]?.imageUri || null)
            }
        }));
    };
    ...
    const handleImageUpload = (itemId: string) => {
        // In a real app, this would use expo-image-picker or expo-camera
        // For now, we simulate picking an image with a dummy URL
        Alert.alert(
            'Ambil Foto',
            'Pilih sumber gambar',
            [
                {
                    ...
                    onPress: () => {
                        setInspectionData(prev => ({
                            ...
                            [itemId]: {
                                ...prev[itemId],
                                imageUri: 'https://via.placeholder.com/300/EF4444/FFFFFF?text=FOTO+BUKTI+KERUSAKAN' // Dummy image
                            }
                        }));
                    }
                },
                {
                    ...
                    onPress: () => {
                        setInspectionData(prev => ({
                            ...
                            [itemId]: {
                                ...prev[itemId],
                                imageUri: 'https://via.placeholder.com/300/EF4444/FFFFFF?text=FOTO+DARI+GALERI' // Dummy image
                            }
                        }));
                    }
                },
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.unitInfoBar}>
                <View>
                    ...
                    <Text style={styles.unitCode}>{id}</Text>
                </View>
                    ...
                    <View key={section.id} style={styles.sectionContainer}>
                        ...
                        <View style={styles.sectionItems}>
                            {section.items.map((item) => {
                                const itemState = inspectionData[item.id] || { status: null, reason: '', imageUri: null };
                                                ...
                                                <View style={styles.issueInputContainer}>
                                                    ...
                                                    {itemState.imageUri ? (
                                                        <TouchableOpacity onPress={() => handleImageUpload(item.id)}>
                                                            <Image source={{ uri: itemState.imageUri }} style={styles.previewImage} />
                                                        ...
                                                        >
                                                            ...
                                                            <Text style={styles.photoUploadText}>Ambil Foto Bukti</Text>
                                                        </TouchableOpacity>
                                                    )}
                                                </View>
                                            )}
